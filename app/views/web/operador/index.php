        ...
        <section class="border border-[#facc15]/30 rounded-2xl overflow-hidden bg-[#1f2937] shadow-2xl shadow-black/50">
            ...
            <div class="bg-black border-b border-[#facc15]/20 px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="h-14 w-14 rounded-xl border border-[#facc15]/30 bg-[#1f2937] flex items-center justify-center overflow-hidden">
                        <img
...
<div class="flex items-center gap-3 flex-wrap">
    <span class="inline-flex items-center px-4 py-2 rounded-lg border border-[#facc15]/30 text-[#facc15] text-sm font-semibold bg-[#1f2937]">
                ...
                <aside class="bg-black border-r border-[#facc15]/10 p-6">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <div class="mt-6 w-full border-t border-[#facc15]/15 pt-5">
                            ...
                            <img
                                src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=<?= $qrTexto ?>"
                                alt="QR del operador"
                                class="mx-auto border border-[#facc15]/20 bg-white p-2 rounded-lg"
                            >
                        </div>

                        <form action="<?= BASE_URL ?>/operador/actualizarFoto"
                              method="POST"
                              enctype="multipart/form-data"
                              class="mt-6 w-full border-t border-[#facc15]/15 pt-5">
    ...
    <div id="formCambiarClave" class="hidden mt-6 bg-[#111827] border border-[#374151] rounded-xl p-4">
    <h2 class="text-lg font-bold text-[#c8982e] mb-4">Actualizar clave</h2>

    <form action="<?= BASE_URL ?>/operador/cambiarClave" method="POST" class="space-y-4">
                ...
                <main class="p-6 md:p-8 space-y-8">
                    ...
                    <section>
                        ...
                        <?php if (!empty($_SESSION['success_operador'])): ?>
                            <div class="mb-4 px-4 py-3 rounded-lg border border-green-500/30 bg-green-900/20 text-green-300 text-sm">
                        ...
                        <?php if (!empty($_SESSION['error_operador'])): ?>
                            <div class="mb-4 px-4 py-3 rounded-lg border border-red-500/30 bg-red-900/20 text-red-300 text-sm">
                        ...
                        <form action="<?= BASE_URL ?>/operador/actualizarPerfil" method="POST" id="formEditarPerfil">
                            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-y-5 gap-x-8">
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Nombre completo</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Código</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Rol</label>
                                    <input
                                        type="text"
                                        value="<?= strtoupper(htmlspecialchars($rol)) ?>"
                                        class="w-full px-3 py-2 rounded-lg bg-[#111827] border border-[#facc15]/10 text-gray-300"
                                        disabled
                                    >
                                </div>
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Estado</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Rango</label>
                                    <input
                                        type="text"
                                        value="<?= htmlspecialchars($rango) ?>"
                                        class="w-full px-3 py-2 rounded-lg bg-[#111827] border border-[#facc15]/10 text-gray-300"
                                        disabled
                                    >
                                </div>
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Edad</label>
                                    <input
                                        type="text"
                                        value="<?= htmlspecialchars($edad) ?> años"
                                        class="w-full px-3 py-2 rounded-lg bg-[#111827] border border-[#facc15]/10 text-gray-300"
                                        disabled
                                    >
                                </div>
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Fecha de nacimiento</label>
                                    <input
                                        type="date"
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">País</label>
                                    <input
                                        type="text"
                                        name="pais"
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Teléfono</label>
                                    <input
                                        type="text"
                                        name="telefono"
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Último ascenso</label>
                                    <input
                                        type="text"
                                        value="<?= htmlspecialchars($fechaUltimoAscenso) ?>"
                                        class="w-full px-3 py-2 rounded-lg bg-[#111827] border border-[#facc15]/10 text-gray-300"
                                        disabled
                                    >
                                </div>
                                ...
                                <div>
                                    <label class="text-xs uppercase tracking-widest text-[#facc15] mb-1 block">Última modificación</label>
                                    <input
                                        type="text"
                                        value="<?= htmlspecialchars($fechaModificacion) ?>"
                                        class="w-full px-3 py-2 rounded-lg bg-[#111827] border border-[#facc15]/10 text-gray-300"
                                        disabled
                                    >
                                </div>
                    ...
                    <section class="border-t border-[#facc15]/15 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-8">
                            <div>
                                <p class="text-xs uppercase tracking-widest text-[#facc15] mb-1">Especialidad principal</p>
                    ...
                    <section class="border-t border-[#facc15]/15 pt-6">
                                    ...
                                    <tbody>
                                        <?php foreach ($historial as $item): ?>
                                            <tr class="border-t border-[#facc15]/10 hover:bg-black/40 transition">
                                                ...
                                                <td class="px-4 py-3">
                                                    <span class="inline-flex px-3 py-1 rounded-full border border-green-500/20 text-green-300 bg-green-900/20 text-xs font-semibold">
                                                        <?= htmlspecialchars($item['estado_participacion'] ?? 'N/A') ?>
                                                    </span>
                                                </td>
                                                <td class="px-4 py-3"><?= htmlspecialchars($item['estado_actividad'] ?? 'N/A') ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                        ...
                        <?php else: ?>
                            <div class="border border-[#facc15]/10 rounded-xl px-4 py-5 bg-black">
                                <p class="text-sm text-gray-300">No hay actividades asistidas registradas para este operador.</p>
                            </div>
                        <?php endif; ?>
                    </section>
