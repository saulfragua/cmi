<div class="p-4 text-white bg-black min-h-screen">
    ...
    <h1 class="text-2xl font-bold text-[#c8982e] mb-6">✏️ Editar Curso</h1>

    <form action="<?= BASE_URL ?>/cursos/actualizar"
          method="POST"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="sigla"
                   value="<?= htmlspecialchars($curso['sigla']) ?>"
                   class="w-full bg-black border border-gray-600 px-3 py-2 rounded">
        </div>
        ...
        <div class="mb-4">
            ...
            <?php if (!empty($curso['imagen'])): ?>
                <img src="<?= BASE_URL ?>/assets/img/cursos/<?= htmlspecialchars($curso['imagen']) ?>"
        ...
        <div class="flex gap-3">
            ...
            <a href="<?= BASE_URL ?>/cursos" class="bg-gray-600 px-4 py-2 rounded">Cancelar</a>
        </div>
