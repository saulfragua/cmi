<div class="p-4 text-white bg-black min-h-screen">
    ...
    <h1 class="text-2xl font-bold text-[#c8982e] mb-6">✏️ Editar Unidad</h1>

    <form action="<?= BASE_URL ?>/unidades/actualizar"
          method="POST"
        ...
        <div class="mb-4">
            ...
            <?php if (!empty($unidad['imagen'])): ?>
                <img src="<?= BASE_URL ?>/assets/img/unidades/<?= $unidad['imagen'] ?>"
        ...
        <div class="flex gap-3">
            ...
            <a href="<?= BASE_URL ?>/unidades" class="bg-gray-600 px-4 py-2 rounded">Cancelar</a>
        </div>
